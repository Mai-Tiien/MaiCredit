...
def maicredit_command(message):
    ...
    if rn >= 1:
        ...
        bot.reply_to(message, "Ти розчарувати великий вождь! *Святослав* зробить пуля тобі в лоб вогонь! Ти втратив -{num} МайКредіт".format(name = message.from_user.first_name, num=random.randint(15, 100)), parse_mode="Markdown")
...
if __name__ == "__main__":
    server.run(host="0.0.0.0", port=int(os.environ.get('PORT', 5000)))import telebot
import random
import requests
import os
from bs4 import BeautifulSoup
